...
/**
 * REST controller for managing {@link com.hr.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
public class ProductCategoryResource {
    ...
    public ResponseEntity<List<ProductCategory>> getAllProductCategories(ProductCategoryCriteria criteria, Pageable pageable) {
