...
/**
 * REST controller for managing {@link com.hr.domain.Permission}.
 */
@RestController
@RequestMapping("/api")
public class PermissionResource {
    ...
    public ResponseEntity<List<Permission>> getAllPermissions(PermissionCriteria criteria, Pageable pageable) {
