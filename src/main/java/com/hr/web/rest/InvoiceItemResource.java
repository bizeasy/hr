...
/**
 * REST controller for managing {@link com.hr.domain.InvoiceItem}.
 */
@RestController
@RequestMapping("/api")
public class InvoiceItemResource {
    ...
    public InvoiceItemResource(InvoiceItemService invoiceItemService, InvoiceItemQueryService invoiceItemQueryService) {
    ...
    public ResponseEntity<List<InvoiceItem>> getAllInvoiceItems(InvoiceItemCriteria criteria, Pageable pageable) {
        log.debug("REST request to get InvoiceItems by criteria: {}", criteria);
        Page<InvoiceItem> page = invoiceItemQueryService.findByCriteria(criteria, pageable);
