...
/**
 * REST controller for managing {@link com.hr.domain.InventoryItem}.
 */
@RestController
@RequestMapping("/api")
public class InventoryItemResource {
    ...
    public InventoryItemResource(InventoryItemService inventoryItemService, InventoryItemQueryService inventoryItemQueryService) {
    ...
    public ResponseEntity<List<InventoryItem>> getAllInventoryItems(InventoryItemCriteria criteria, Pageable pageable) {
        log.debug("REST request to get InventoryItems by criteria: {}", criteria);
        Page<InventoryItem> page = inventoryItemQueryService.findByCriteria(criteria, pageable);
     ...
     */
    @GetMapping("/inventory-items/count")
