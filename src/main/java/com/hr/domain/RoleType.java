...
public class RoleType implements Serializable {
    ...
    @ManyToOne
    @JsonIgnoreProperties(value = "roleTypes", allowSetters = true)
    ...
    public RoleType parent(RoleType roleType) {
        this.parent = roleType;
        return this;
    }

    public void setParent(RoleType roleType) {
        this.parent = roleType;
    }
