...
export class StatusComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.statusService
      ...
      .subscribe(
        (res: HttpResponse<IStatus[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInStatuses(): void {
    this.eventSubscriber = this.eventManager.subscribe('statusListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IStatus[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
