...
export class ProductStoreComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.productStoreService
      ...
      .subscribe(
        (res: HttpResponse<IProductStore[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInProductStores(): void {
    this.eventSubscriber = this.eventManager.subscribe('productStoreListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IProductStore[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
