...
export class ReasonComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.reasonService
      ...
      .subscribe(
        (res: HttpResponse<IReason[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IReason[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
