...
export class GeoComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.geoService
      ...
      .subscribe(
        (res: HttpResponse<IGeo[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInGeos(): void {
    this.eventSubscriber = this.eventManager.subscribe('geoListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IGeo[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
