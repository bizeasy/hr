...
export class OrderStatusComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.orderStatusService
      ...
      .subscribe(
        (res: HttpResponse<IOrderStatus[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInOrderStatuses(): void {
    this.eventSubscriber = this.eventManager.subscribe('orderStatusListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IOrderStatus[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
