...
export class StatusCategoryComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.statusCategoryService
      ...
      .subscribe(
        (res: HttpResponse<IStatusCategory[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInStatusCategories(): void {
    this.eventSubscriber = this.eventManager.subscribe('statusCategoryListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IStatusCategory[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
