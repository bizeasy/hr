...
export class PostalAddressComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.postalAddressService
      ...
      .subscribe(
        (res: HttpResponse<IPostalAddress[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInPostalAddresses(): void {
    this.eventSubscriber = this.eventManager.subscribe('postalAddressListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPostalAddress[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/postal-address'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
