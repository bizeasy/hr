...
export class PartyComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.partyService
      ...
      .subscribe(
        (res: HttpResponse<IParty[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInParties(): void {
    this.eventSubscriber = this.eventManager.subscribe('partyListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IParty[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
