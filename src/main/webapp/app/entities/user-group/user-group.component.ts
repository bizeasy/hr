...
export class UserGroupComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.userGroupService
      ...
      .subscribe(
        (res: HttpResponse<IUserGroup[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IUserGroup[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
