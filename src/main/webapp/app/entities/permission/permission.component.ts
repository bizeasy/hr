...
export class PermissionComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.permissionService
      ...
      .subscribe(
        (res: HttpResponse<IPermission[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IPermission[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
