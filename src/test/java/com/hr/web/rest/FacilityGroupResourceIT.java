...
import com.hr.repository.FacilityGroupRepository;
...
public class FacilityGroupResourceIT {
    ...
    public void createFacilityGroup() throws Exception {
        ...
        assertThat(testFacilityGroup.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
    }
    ...
    public void updateFacilityGroup() throws Exception {
        ...
        assertThat(testFacilityGroup.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
    }
