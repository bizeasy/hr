    ...
    val scn = scenario("Test the Equipment entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                ...
                , "equipmentNumber":"SAMPLE_TEXT"
                , "minCapacityRange":null
                , "maxCapacityRange":null
                , "minOperationalRange":null
                , "maxOperationalRange":null
                , "lastCalibratedDate":"2020-01-01T00:00:00.000Z"
                , "calibrationDueDate":"2020-01-01T00:00:00.000Z"
                , "changeControlNo":"SAMPLE_TEXT"
                }""")).asJson
            .check(status.is(201))
