...
import { PaymentApplicationComponent } from 'app/entities/payment-application/payment-application.component';
...
describe('Component Tests', () => {
  describe('PaymentApplication Management Component', () => {
    let comp: PaymentApplicationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(PaymentApplicationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new PaymentApplication(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.paymentApplications && comp.paymentApplications[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
