...
import { InventoryTransferComponent } from 'app/entities/inventory-transfer/inventory-transfer.component';
...
describe('Component Tests', () => {
  describe('InventoryTransfer Management Component', () => {
    let comp: InventoryTransferComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(InventoryTransferComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new InventoryTransfer(123)],
            headers,
          })
        )
      );
      ...
      expect(comp.inventoryTransfers && comp.inventoryTransfers[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
