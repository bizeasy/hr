...
describe('Service Tests', () => {
  describe('DeductionType Service', () => {
    ...
    let elemDefault: IDeductionType;
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(DeductionTypeService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new DeductionType(0, 'AAAAAAA', 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a DeductionType', () => {
        ...
        service.create(new DeductionType()).subscribe(resp => (expectedResult = resp.body));
