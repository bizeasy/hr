...
export class GeoAssocUpdatePage {
  ...
  async geoSelectLastOption(): Promise<void> {
    await this.geoSelect.all(by.tagName('option')).last().click();
  }
  ...
  async geoToSelectLastOption(): Promise<void> {
    await this.geoToSelect.all(by.tagName('option')).last().click();
  }
  ...
  async geoAssocTypeSelectLastOption(): Promise<void> {
    await this.geoAssocTypeSelect.all(by.tagName('option')).last().click();
  }
