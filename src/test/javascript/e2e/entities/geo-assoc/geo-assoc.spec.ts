...
describe('GeoAssoc e2e test', () => {
  ...
  it('should load GeoAssocs', async () => {
    ...
    expect(await geoAssocComponentsPage.getTitle()).to.eq('hrApp.geoAssoc.home.title');
  ...
  it('should load create GeoAssoc page', async () => {
    ...
    expect(await geoAssocUpdatePage.getPageTitle()).to.eq('hrApp.geoAssoc.home.createOrEditLabel');
  ...
  it('should delete last GeoAssoc', async () => {
    ...
    expect(await geoAssocDeleteDialog.getDialogTitle()).to.eq('hrApp.geoAssoc.delete.question');
