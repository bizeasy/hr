...
describe('FacilityGroupType e2e test', () => {
  ...
  it('should load FacilityGroupTypes', async () => {
    ...
    expect(await facilityGroupTypeComponentsPage.getTitle()).to.eq('hrApp.facilityGroupType.home.title');
    await browser.wait(
  ...
  it('should load create FacilityGroupType page', async () => {
    ...
    expect(await facilityGroupTypeUpdatePage.getPageTitle()).to.eq('hrApp.facilityGroupType.home.createOrEditLabel');
  ...
  it('should delete last FacilityGroupType', async () => {
    ...
    expect(await facilityGroupTypeDeleteDialog.getDialogTitle()).to.eq('hrApp.facilityGroupType.delete.question');
