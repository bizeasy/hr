...
describe('GeoType e2e test', () => {
  ...
  it('should load GeoTypes', async () => {
    ...
    expect(await geoTypeComponentsPage.getTitle()).to.eq('hrApp.geoType.home.title');
  ...
  it('should load create GeoType page', async () => {
    ...
    expect(await geoTypeUpdatePage.getPageTitle()).to.eq('hrApp.geoType.home.createOrEditLabel');
  ...
  it('should delete last GeoType', async () => {
    ...
    expect(await geoTypeDeleteDialog.getDialogTitle()).to.eq('hrApp.geoType.delete.question');
