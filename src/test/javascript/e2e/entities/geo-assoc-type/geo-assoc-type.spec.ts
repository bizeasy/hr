...
describe('GeoAssocType e2e test', () => {
  ...
  it('should load GeoAssocTypes', async () => {
    ...
    expect(await geoAssocTypeComponentsPage.getTitle()).to.eq('hrApp.geoAssocType.home.title');
    await browser.wait(
  ...
  it('should load create GeoAssocType page', async () => {
    ...
    expect(await geoAssocTypeUpdatePage.getPageTitle()).to.eq('hrApp.geoAssocType.home.createOrEditLabel');
  ...
  it('should delete last GeoAssocType', async () => {
    ...
    expect(await geoAssocTypeDeleteDialog.getDialogTitle()).to.eq('hrApp.geoAssocType.delete.question');
