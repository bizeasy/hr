...
describe('GeoPoint e2e test', () => {
  ...
  it('should load GeoPoints', async () => {
    ...
    expect(await geoPointComponentsPage.getTitle()).to.eq('hrApp.geoPoint.home.title');
  ...
  it('should load create GeoPoint page', async () => {
    ...
    expect(await geoPointUpdatePage.getPageTitle()).to.eq('hrApp.geoPoint.home.createOrEditLabel');
  ...
  it('should delete last GeoPoint', async () => {
    ...
    expect(await geoPointDeleteDialog.getDialogTitle()).to.eq('hrApp.geoPoint.delete.question');
