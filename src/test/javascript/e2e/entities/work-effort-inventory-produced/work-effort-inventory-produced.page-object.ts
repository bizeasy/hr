...
export class WorkEffortInventoryProducedComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('sys-work-effort-inventory-produced div table .btn-danger'));
  title = element.all(by.css('sys-work-effort-inventory-produced div h2#page-heading span')).first();
...
export class WorkEffortInventoryProducedUpdatePage {
  pageTitle = element(by.id('sys-work-effort-inventory-produced-heading'));
...
export class WorkEffortInventoryProducedDeleteDialog {
  private dialogTitle = element(by.id('sys-delete-workEffortInventoryProduced-heading'));
  private confirmButton = element(by.id('sys-confirm-delete-workEffortInventoryProduced'));
