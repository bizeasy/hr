...
export class PartyContactMechComponentsPage {
  createButton = element(by.id('jh-create-entity'));
  deleteButtons = element.all(by.css('sys-party-contact-mech div table .btn-danger'));
  title = element.all(by.css('sys-party-contact-mech div h2#page-heading span')).first();
...
export class PartyContactMechUpdatePage {
  pageTitle = element(by.id('sys-party-contact-mech-heading'));
...
export class PartyContactMechDeleteDialog {
  private dialogTitle = element(by.id('sys-delete-partyContactMech-heading'));
  private confirmButton = element(by.id('sys-confirm-delete-partyContactMech'));
