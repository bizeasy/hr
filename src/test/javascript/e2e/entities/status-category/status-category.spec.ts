...
describe('StatusCategory e2e test', () => {
  ...
  it('should load StatusCategories', async () => {
    ...
    expect(await statusCategoryComponentsPage.getTitle()).to.eq('hrApp.statusCategory.home.title');
    await browser.wait(
  ...
  it('should load create StatusCategory page', async () => {
    ...
    expect(await statusCategoryUpdatePage.getPageTitle()).to.eq('hrApp.statusCategory.home.createOrEditLabel');
  ...
  it('should delete last StatusCategory', async () => {
    ...
    expect(await statusCategoryDeleteDialog.getDialogTitle()).to.eq('hrApp.statusCategory.delete.question');
