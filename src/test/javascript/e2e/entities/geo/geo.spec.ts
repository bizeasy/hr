...
describe('Geo e2e test', () => {
  ...
  it('should load Geos', async () => {
    ...
    expect(await geoComponentsPage.getTitle()).to.eq('hrApp.geo.home.title');
  ...
  it('should load create Geo page', async () => {
    ...
    expect(await geoUpdatePage.getPageTitle()).to.eq('hrApp.geo.home.createOrEditLabel');
  ...
  it('should delete last Geo', async () => {
    ...
    expect(await geoDeleteDialog.getDialogTitle()).to.eq('hrApp.geo.delete.question');
