...
describe('FacilityType e2e test', () => {
  ...
  it('should load FacilityTypes', async () => {
    ...
    expect(await facilityTypeComponentsPage.getTitle()).to.eq('hrApp.facilityType.home.title');
    await browser.wait(
  ...
  it('should load create FacilityType page', async () => {
    ...
    expect(await facilityTypeUpdatePage.getPageTitle()).to.eq('hrApp.facilityType.home.createOrEditLabel');
  ...
  it('should delete last FacilityType', async () => {
    ...
    expect(await facilityTypeDeleteDialog.getDialogTitle()).to.eq('hrApp.facilityType.delete.question');
